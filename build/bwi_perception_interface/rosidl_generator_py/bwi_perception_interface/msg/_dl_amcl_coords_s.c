...
bool bwi_perception_interface__msg__dl_amcl_coords__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bwi_perception_interface.msg._dl_amcl_coords.DlAmclCoords", full_classname_dest, 57) == 0);
  }
  bwi_perception_interface__msg__DlAmclCoords * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of DlAmclCoords */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("bwi_perception_interface.msg._dl_amcl_coords");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DlAmclCoords");
