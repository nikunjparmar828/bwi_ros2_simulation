...
static const _DlAmclCoords_type_support_symbol_names_t _DlAmclCoords_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bwi_perception_interface, msg, DlAmclCoords)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bwi_perception_interface, msg, DlAmclCoords)),
  }
};
...
{
  return &::bwi_perception_interface::msg::rosidl_typesupport_cpp::DlAmclCoords_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bwi_perception_interface, msg, DlAmclCoords)() {
  return get_message_type_support_handle<bwi_perception_interface::msg::DlAmclCoords>();
}
