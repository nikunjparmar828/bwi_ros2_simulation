...
class BwibotDetection(Node):
    def __init__(self):
        super().__init__('bwibot_detection_node_r1')

        # ---------- TOPICS ----------
        self.rgb_topic   = '/r1/nav_kinect/image_raw'
        self.depth_topic = '/r1/nav_kinect/depth/image_raw'
        self.amcl_topic  = '/r1/amcl_pose'
        ...
        self.create_subscription(PoseWithCovarianceStamped, self.r2_amcl_topic, self.r2_amcl_cb, amcl_qos)

        self.r2_amcl_dl_pub = self.create_publisher(DlAmclCoords, self.r2_amcl_topic_dl, 10)
    ...
    def run_once(self):
        ...
        for obb in results[0].obb.xyxyxyxy:
            ...
            # label = f"Z={Z:.2f}m | map=({x_map:.2f},{y_map:.2f}) | r2=({self.r2_x:.2f}, {self.r2_y:.2f})"
            ...
            msg.y = y_map
            msg.depth = float(Z)
            self.r2_amcl_dl_pub.publish(msg)
