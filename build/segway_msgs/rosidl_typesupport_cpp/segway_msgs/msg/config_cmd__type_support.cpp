...
static const _ConfigCmd_type_support_symbol_names_t _ConfigCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, segway_msgs, msg, ConfigCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, segway_msgs, msg, ConfigCmd)),
  }
};
...
{
  return &::segway_msgs::msg::rosidl_typesupport_cpp::ConfigCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, segway_msgs, msg, ConfigCmd)() {
  return get_message_type_support_handle<segway_msgs::msg::ConfigCmd>();
}
