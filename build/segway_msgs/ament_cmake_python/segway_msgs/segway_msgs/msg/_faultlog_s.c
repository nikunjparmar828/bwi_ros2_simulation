...
bool segway_msgs__msg__faultlog__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("segway_msgs.msg._faultlog.Faultlog", full_classname_dest, 34) == 0);
  }
  segway_msgs__msg__Faultlog * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of Faultlog */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("segway_msgs.msg._faultlog");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Faultlog");
