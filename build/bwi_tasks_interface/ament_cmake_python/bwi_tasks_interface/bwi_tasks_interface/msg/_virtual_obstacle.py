...
class Metaclass_VirtualObstacle(type):
    """Metaclass of message 'VirtualObstacle'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('bwi_tasks_interface')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'bwi_tasks_interface.msg.VirtualObstacle')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__virtual_obstacle
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__virtual_obstacle
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__virtual_obstacle
            cls._TYPE_SUPPORT = module.type_support_msg__msg__virtual_obstacle
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__virtual_obstacle
...
class VirtualObstacle(metaclass=Metaclass_VirtualObstacle):
    """Message class 'VirtualObstacle'."""
