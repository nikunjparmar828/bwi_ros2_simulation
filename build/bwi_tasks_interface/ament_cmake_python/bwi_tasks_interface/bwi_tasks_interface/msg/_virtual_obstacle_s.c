...
bool bwi_tasks_interface__msg__virtual_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bwi_tasks_interface.msg._virtual_obstacle.VirtualObstacle", full_classname_dest, 57) == 0);
  }
  bwi_tasks_interface__msg__VirtualObstacle * ros_message = _ros_message;
  {  // poses
...
{
  /* NOTE(esteve): Call constructor of VirtualObstacle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("bwi_tasks_interface.msg._virtual_obstacle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VirtualObstacle");
